...
//        private readonly CategoryLogic subCategoryLogic;
//        private readonly AdjValueLogic adjValueLogic;
//        private readonly KeyToSubCategoryLogic keyToSubCategoryLogic;
//        public TechnicalSpecificationController(KeyToSubCategoryLogic keyToSubCategoryLogic, AdjValueLogic adjValueLogic, CategoryLogic categoryLogic, AdjKeyLogic adjKeyLogic, HeadCategoryLogic headCategoryLogic, CategoryLogic subCategoryLogic)
//        {
...
//            ViewBag.HeadCategories = new SelectList(headCategories, "Id", "Name");
//            return View();
//        }
//        [HttpPost]
...
//        }
//        [HttpGet("TechnicalSpecification/SubCategoryDropDown/Id")]
//        public JsonResult SubCategoryDropDown(int category_Id,int Id)
//        {
//            if (category_Id != 0)
//            {
...
//                var subcategooriesId = keyToSubCategoryLogic.KeyToSubCategoryList().Where(ks => ks.key_Id == Id).Select(c => c.SubCategory_Id).ToList();
//                var subcategories = subCategoryLogic.SubCategoryList().Where(s => s.category_Id == category.Id).ToList();
//                #endregion
//                return Json(new SelectList(subcategories, "Id", "Name", subcategooriesId));
//            }
...
//            var categoryId = subcategooriesId.Select(ks => ks.subCategory.category_Id).FirstOrDefault();
//            var headCategoryid = categoryLogic.CategoryDetail(categoryId).headCategory_Id;
...
//            };
//            var headCategories = headCategoryLogic.HeadCategoryList();
//            var categories = categoryLogic.CategoryList().Where(c => c.headCategory_Id == headCategoryid).ToList();
//            ViewBag.HeadCategories = new SelectList(headCategories, "Id", "Name",headCategoryid);
