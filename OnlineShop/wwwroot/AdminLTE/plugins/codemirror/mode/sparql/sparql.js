...
CodeMirror.defineMode("sparql", function(config) {
  ...
  var ops = wordRegexp(["str", "lang", "langmatches", "Description", "bound", "sameterm", "isiri", "isuri",
  ...
  var keywords = wordRegexp(["base", "prefix", "select", "AdminLTE/distinct", "reduced", "construct", "describe",
